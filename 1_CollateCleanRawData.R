############################################################################################################################################################################
### This code was written by Hannah Wauchope to clean data for the paper "Robust study design shows variable impact of protected areas on waterbirds"
...
### It cleans the data by taxonomically standardising species names by the currently used names in Birdlife International, sorts out cases of multiple counts, removes any sites with suspicious coordinats, and imputes zeroes
###
...
#Remove error sites that Tatsuya found (in process of Nature paper: "Successful conservation of global waterbird populations depends on effective governanc" 2017) (error by very bogus coordinates). WI have cleaned a lot of these now! So identify the few unchanged ones and remove those
