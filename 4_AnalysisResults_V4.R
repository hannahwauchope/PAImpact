...
### Last edited 20th December, 2021
...
### NOTES: For reasons known only to past me, I labelled the cumulative link models that correlate predictors with protected area impacts (i.e. for Fig 4 etc) as "Category Models". Unsure why, but they are referred to as such throughout this script.
############################################################################################################################################################################
...
#### CLMM Proportional Odds Ratio - Check Assumptions (Figure S10, 11); Plus obtaining effect sizes reported in main text ####
Database <- "Waterbird"
